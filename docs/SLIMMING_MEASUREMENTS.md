...
measured on a WSL2 dev host against `genworks/readymacs:devo-full` (then still named skewed-emacs)
...
| readymacs repo copy (dot-files 77, docker/ 65 -- see dup below) | 147MB |
