...
`./basalt up` → dashboard → an AI agent driving Gendl through MCP.

## Storyboard

1. (~5s) `./basalt up` scrolling, ending on healthy services.
2. (~5s) `rmacs` → the Readymacs dashboard (ASCII banner, backends green).
